...
#include <memory>
#include "../../../../Apper/TransactionHistory.h"
...
QT_MOC_LITERAL(1, 19, 15), // "setFilterRegExp"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 6), // "regexp"
QT_MOC_LITERAL(4, 43, 38), // "on_treeView_customContextMenu..."
QT_MOC_LITERAL(5, 82, 3), // "pos"
QT_MOC_LITERAL(6, 86, 11) // "refreshList"

    },
    "TransactionHistory\0setFilterRegExp\0\0"
    "regexp\0on_treeView_customContextMenuRequested\0"
    "pos\0refreshList"
};
...
void TransactionHistory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TransactionHistory *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TransactionHistory::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_TransactionHistory.data,
    qt_meta_data_TransactionHistory,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TransactionHistory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::TransactionHistory"))
        return static_cast< Ui::TransactionHistory*>(this);
